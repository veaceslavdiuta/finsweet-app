    ...
    <section className="flex w-full justify-center bg-tint-blue py-32">
      <div className="flex w-full max-w-screen-xl items-center justify-between gap-x-16">
        <div className="flex w-1/2 flex-col gap-y-8">
          <h1 className="font-poppins non-italic text-6xl font-semibold leading-snug text-white">
            Building stellar websites for early startups
          </h1>
          <p className="font-poppins non-italic text-base font-normal text-white opacity-70">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt.
          </p>
          <div className="flex gap-x-10">
            <button className="font-poppins inline-flex items-center justify-center rounded-custom-41 bg-yelow px-14 py-4 text-base font-semibold leading-8">
              View our work
            </button>
            <button className="font-poppins flex items-center justify-center gap-4 text-base font-medium leading-7 text-white">
              View Pricing
              <svg
